    <nav class="navbar navbar-expand-md navbar-light">
        <div class="container-fluid">
            <!--<a class="navbar-brand" href="index.html"><img class="logoAnim img-fluid" src="assets/img/logo-min.png" width="270"
                    alt="logo"></a>-->
            ...
            <div class="collapse navbar-collapse flex-row" id="navbarToggler">
                <ul class="nav navbar-nav nav-pills">
                    <li class="nav-item active"><a class="nav-link" href="index.php">Accueil<span class="sr-only">(page
                                actuelle)</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="lecture.php">Lire</a></li>
                    <li class="nav-item"><a class="nav-link" href="apropos.php">À propos</a></li>
                </ul>
            </div>
        </div>
        <div class="d-inline float-right FRENG">
